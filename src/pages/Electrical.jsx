// src/pages/Electrical.jsx
import React from "react";
import "./Electrical.css"; // custom styles
  ...
  return (
     ...
     <section className="our-services-section py-5">
      <div className="container text-center">
        ...
        <div className="service-box mx-auto shadow rounded overflow-hidden">
          <img src="./Images/Electa.png" alt="Electrical Service" className="w-100 service-img" />
    ...
    />
                ...
                <p className="card-text text-muted">
                  Expert electrical installation services for new builds,
                  renovations, and upgrades. Our licensed electricians ensure
    ...
    />
                ...
                <p className="card-text text-muted">
                  Expert energy efficiency solutions to reduce energy
