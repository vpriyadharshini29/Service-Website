  ...
  return (
     ...
     <section className="our-services-section py-5">
      <div className="container text-center">
        ...
        <div className="service-box mx-auto shadow rounded overflow-hidden">
          <img src="./Images/CCTV1.png" alt="Electrical Service" className="w-100 service-img" />
    ...
    />
                ...
                <p className="card-text text-muted">
                  CCTV installation services for new builds,
    ...
    />
                ...
                <p className="card-text text-muted">
                  cctv monitoring solutions to reduce energy
    ...
    />
                ...
                <p className="card-text text-muted">
                our maintanences services to fix faults, prevent
